...
| --- | --- | --- | --- | --- | --- |
| `JN-BOOTSTRAP-INTERPRETER-PROFILE-PLAN-001` | Stage the hosted Jazz bootstrap interpreter profile | `No accepted post-parser child after hosted parser parity` | The hosted lexer and all five parser grammar children are complete. Six fixed families assign all 365 parser fixtures exactly once and match stage 0 through both façades twice; all four scale profiles are deterministic with zero host operations. Canonical core, backend-neutral lowered IR, LLVM lowering, object/link production, and native runtime remain separate ordered stages with no accepted child to promote. | [2026-07-10-jazz-next-bootstrap-interpreter-profile-design.md](../superpowers/specs/2026-07-10-jazz-next-bootstrap-interpreter-profile-design.md) | `2026-07-20` |
