...
Last verified against commit: `e8be080`
...
| Module/import syntax               | `Partially Implemented`              | `jazz-next` parses canonical brace-bodied module declarations plus import alias/symbol-list forms into a parse-once `ResolvedProgram`; resolver, compiled-interface, and runtime selection share the namespace-aware inventory in `jazz-next/src/JazzNext/Compiler/ModuleExports.hs`, with explicit class capability selection, alias-hidden capabilities, and non-transitive class boundaries preserved across `jazz-next/src/JazzNext/Compiler/{ModuleResolver.hs,ModuleInterface.hs,ModuleCompiler.hs,ModuleRuntime.hs}`. The v1 path has parser, inventory, resolver, loader, CLI, and migration-harness coverage (`jazz-next/test/JazzNext/Compiler/Parser/ModuleImportParserSpec.hs`, `jazz-next/test/JazzNext/Compiler/Modules/{ModuleExportsSpec.hs,ModuleResolutionSpec.hs,LoaderSpec.hs,ModulePipelineContractSpec.hs}`, `jazz-next/test/JazzNext/CLI/CLISpec.hs`; `docs/spec/modules/{00-module-clarification-matrix.md,01-file-layout-and-package-roots.md,02-resolution-algorithm-and-cycles.md,03-loader-behavior-and-diagnostics.md,04-qualified-imports-and-binding.md,05-migration-and-compatibility.md`). Broader package metadata, re-export, wildcard/hiding import forms, persistent cache behavior, and additional stdlib/catalog growth remain future work behind concrete contracts. |
