...
Last verified against commit: `073da56`
...
| Module/import syntax               | `Partially Implemented`              | `jazz-next` parses canonical brace-bodied module declarations plus import alias/symbol-list forms, and the v1 module graph path now has parser, resolver, loader, CLI, and migration-harness coverage (`jazz-next/src/JazzNext/Compiler/Parser.hs`, `jazz-next/src/JazzNext/Compiler/ModuleResolver.hs`, `jazz-next/src/JazzNext/CLI/Main.hs`, `jazz-next/test/JazzNext/Compiler/Parser/ModuleImportParserSpec.hs`, `jazz-next/test/JazzNext/Compiler/Modules/{ModuleResolutionSpec.hs,LoaderSpec.hs}`, `jazz-next/test/JazzNext/CLI/CLISpec.hs`; `docs/spec/modules/{00-module-clarification-matrix.md,01-file-layout-and-package-roots.md,02-resolution-algorithm-and-cycles.md,03-loader-behavior-and-diagnostics.md,04-qualified-imports-and-binding.md,05-migration-and-compatibility.md}`). Broader package metadata, re-export, wildcard/hiding import forms, persistent cache behavior, and additional stdlib/catalog growth remain future work behind concrete contracts. |
