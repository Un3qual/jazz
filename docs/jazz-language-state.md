...
- Extending class/impl abstraction semantics in `jazz-next` beyond the active
  ...
  class plus default concrete impl facts; method bodies, dispatch,
  dictionaries, default methods, broader default facts, superclass semantics,
