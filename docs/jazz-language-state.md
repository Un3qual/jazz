...
- Extending class/impl abstraction semantics in `jazz-next` beyond the active
  ...
  diagnostics, and impl bodies validated against substituted method types. The
  ...
  values, dictionaries, default methods, superclass semantics, inferred
