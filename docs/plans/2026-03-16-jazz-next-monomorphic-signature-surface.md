...
- [ ] Task 2 complete: `jazz-next` parses/checks concrete list and simple function signatures.
- [ ] Task 3 complete: docs/trackers reflect the new supported subset and verification passes.
