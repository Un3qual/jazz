---
id: JN-ADT-LIST-PATTERN-TYPE-001
status: done
priority: P1
size: M
kind: impl
...
plan_section: "Milestone 3 / Batch 3: Bracketed-list pattern typing"
target_paths:
...
deliverable: "Bracketed-list patterns typecheck against list scrutinees, bind element variables in arm bodies, and participate in branch result agreement while constructor/list runtime matching remains deferred."
supersedes:
...
- [x] On `2026-04-24`, landed bracketed-list pattern type semantics, including list-scrutinee checks, element binder typing, and ordinary branch result agreement, while leaving constructor/list runtime matching deferred.
...
| Active verification | `jazz-next/test/JazzNext/Compiler/Parser/*.hs`, `jazz-next/test/JazzNext/Compiler/Semantics/*.hs`, `jazz-next/test/JazzNext/CLI/CLISpec.hs` | Parser coverage includes constructor/list forms and case-boundary regressions; semantic coverage now includes constructor values/applications plus constructor and bracketed-list pattern typing while runtime matching still covers the committed simple-pattern subset. | Extend runtime coverage as constructor/list runtime matching support lands. |
...
This batch landed on `2026-04-24`. It adds compile-time type semantics for bracketed-list patterns while leaving constructor/list pattern runtime matching queued as separate follow-up work.
