...
plan_section: "Completed implementation batch: CLI help output"
target_paths:
...
## Completed implementation batch: CLI help output

Completed on `2026-06-24`. The `jazz-next` CLI now handles `--help` and
`-h` before argument validation, env lookup, config/prelude/source reads, or
module graph file reads.
...
- [x] **Step 2: Add the help flag predicate**
...
- [x] **Step 3: Return help before normal argument work**
...
- [x] **Step 4: Recognize help in parseCliOptions for direct parser callers**
...
- [x] **Step 1: Add help command documentation**
