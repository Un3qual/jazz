...
The next executor does not need a broad docs scan. It should define migration and compatibility constraints using this matrix, `docs/spec/modules/01-file-layout-and-package-roots.md`, `docs/spec/modules/02-resolution-algorithm-and-cycles.md`, `docs/spec/modules/03-loader-behavior-and-diagnostics.md`, `docs/spec/modules/04-qualified-imports-and-binding.md`, and the active `jazz-next` parser/CLI behavior as evidence.
