...
The next executor does not need a broad docs scan. It should define loader pipeline behavior using this matrix, `docs/spec/modules/01-file-layout-and-package-roots.md`, `docs/spec/modules/02-resolution-algorithm-and-cycles.md`, and the active `jazz-next` driver/loader behavior as evidence.
