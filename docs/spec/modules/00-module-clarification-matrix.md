...
The next executor does not need a broad docs scan. It should define qualified import and name-binding behavior using this matrix, `docs/spec/modules/01-file-layout-and-package-roots.md`, `docs/spec/modules/02-resolution-algorithm-and-cycles.md`, `docs/spec/modules/03-loader-behavior-and-diagnostics.md`, and the active `jazz-next` resolver/driver behavior as evidence.
