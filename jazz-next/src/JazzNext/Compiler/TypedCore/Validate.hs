...
interfaceImplIds (modulePath, _, TypedModule _ _ _ _ (TypedModuleInterface _ _ _ impls) _ _) =
  [qualifyExternalImplId modulePath implId | TypedImplInterface implId <- impls]
