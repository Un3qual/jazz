...
tests =
  [ ("owns centralized operator metadata", testOperatorMetadata),
    ...
    ("parses standalone declarations", assertStage0Parity "standalone declaration" "operator %% tier 2."),
    ("threads declarations to following statements", assertStage0Parity "declaration source order" "operator %% tier 2. x = 1."),
    ...
    ("parses simple declared signatures and bindings", assertStage0Parity "simple operator signature binding" "operator %% tier 2. (%%) :: Int. (%%) = 1."),
