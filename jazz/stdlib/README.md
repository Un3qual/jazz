...
| Operation family   | Public values                                                                   | Complexity                                                                                                                           |
| ------------------ | ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| Construction/views | `Map::empty`, `Map::singleton`, `Map::fromList`, `Map::toList`                  | Empty/singleton `O(1)`; from-list `O(n log n)`; to-list `O(n)`                                                                       |
...
| Transforming      | `Text::map`                                                                                                                                             | `O(n)` plus callback work                                                                                                                  |
