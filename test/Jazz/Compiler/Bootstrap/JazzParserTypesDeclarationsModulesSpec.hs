...
tests =
  [ ("snapshots the remaining canonical tokens without consumption", testTokenRemaining),
    ...
    ("keeps qualified constraints inside signature payloads", assertStage0Parity "qualified constraint statement boundary" "constrained :: @{Eq(a), Alias::Ord(List(a))}: a -> List(a)."),
    ("rejects overlong qualified constraint heads", assertStage0Parity "overlong qualified constraint head" "item :: @{Alias::Class::Extra}: Int."),
    ("falls back from compact signatures with malformed constraint heads", assertStage0Parity "compact overlong qualified constraint head" "item::@{Alias::Class::Extra}: Int."),
    ("validates parenthesized qualified constraint heads", assertStage0Parity "parenthesized overlong qualified constraint head" "item :: @{(Alias::Class::Extra)}: Int."),
    ("validates later qualified constraint heads", assertStage0Parity "later overlong qualified constraint head" "item :: @{Eq(a), Alias::Class::Extra}: Int."),
    ("preserves unsupported type arguments inside constraints", assertStage0Parity "overlong qualified constraint type argument" "item :: @{Eq(Alias::Class::Extra)}: Int."),
    ...
    ("preserves unsupported signatures with spaced type qualifiers", assertStage0Parity "spaced signature type qualifier" "item :: Alias ::Int."),
    ("preserves unsupported signatures with spaced type members", assertStage0Parity "spaced signature type member" "item :: Alias:: Int."),
    ...
    ("rejects spaced data field type qualifiers", assertStage0Parity "spaced data field type qualifier" "data Box = Box Alias ::Int."),
    ("rejects spaced data field type members", assertStage0Parity "spaced data field type member" "data Box = Box Alias:: Int."),
    ...
    ("parses qualified methods in binding expressions", assertStage0Parity "qualified method binding expression" "result = Alias::Class::method."),
    ("rejects missing qualified method names before a dot", assertStage0Parity "qualified method name before dot" "result = Alias::Class::."),
    ("rejects whitespace before qualified method names", assertStage0Parity "nonadjacent qualified method name" "result = Alias::Class:: method."),
    ("preserves qualified method name EOF context", assertStage0Parity "qualified method name EOF" "result = Alias::Class::"),
    ("rejects overlong qualified method binding expressions", assertStage0Parity "overlong qualified method binding expression" "result = Alias::Class::method::extra."),
    ("parses unmatched three-component names as qualified methods", assertStage0Parity "unmatched qualified constructor payload" "Result::Alias::a."),
    ...
    ("preserves constructor extra qualification with signature syntax", assertStage0Parity "constructor multiply-qualified payload with later syntax" "Result::Alias::Member::Extra -> D."),
    ...
    ("preserves constructor extra qualification before matching bindings", assertStage0Parity "constructor multiply-qualified payload before matching binding" "Result::Alias::Member::Extra. Result = 0."),
