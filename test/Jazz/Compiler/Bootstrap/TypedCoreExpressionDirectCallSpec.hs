...
tests =
  [ ("audits the complete producer fixture manifest", testFixtureManifest),
    ...
    ("lowers the lifted lambda regression to valid Lowered IR", testLiftedLambdaLowering),
    ...
    ("lowers the full valid UInt64 domain exactly", testFullUInt64Lowering),
    ...
    ("lowers every independent unary closure boundary exactly", testSupportedClosureLowererBoundary),
    ...
    ("preserves numeric captures through analyzed source programs", testCapturedNumericSourcePrograms),
    ...
    ("ranks module failures before statement failures in authored export selector order", testModuleFailureOrder),
    ("emits typed module exports in authored export selector order", testModuleArtifactExportOrder),
