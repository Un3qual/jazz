...
expectedBuiltins =
  [ (BuiltinMap, "map", 2, PreludeTarget),
    ...
    (BuiltinCharIsLower, "charIsLower", 1, KernelIntrinsic),
    (BuiltinCharIsUpper, "charIsUpper", 1, KernelIntrinsic),
    (BuiltinCharToLower, "charToLower", 1, KernelIntrinsic),
    (BuiltinCharToUpper, "charToUpper", 1, KernelIntrinsic),
    ...
    (BuiltinTextConcat, "textConcat", 1, KernelIntrinsic),
