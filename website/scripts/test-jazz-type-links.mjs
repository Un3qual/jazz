...
test('maps every named module type and capability to its canonical route', () => {
  const cases = [
    ...
    ['Equatable', 9, '/docs/standard-library/prelude#equatable'],
    ['Comparable', 10, '/docs/standard-library/prelude#comparable'],
    ['Mappable', 8, '/docs/standard-library/prelude#mappable'],
    ['Reducible', 9, '/docs/standard-library/prelude#reducible'],
    ['Combinable', 10, '/docs/standard-library/prelude#combinable'],
