...
test('homepage modification date tracks every rendered source group', () => {
  assertTrackedSources(
    ...
    [
      ...
      ['website/src/theme/CodeBlock/Content/index.tsx', '2026-08-13'],
      ['website/scripts/jazz-highlighter.mjs', '2026-08-14'],
...
test('documentation modification date tracks every shared rendered source group', () => {
  assertTrackedSources(
    ...
    [
      ...
      ['website/src/theme/DocItem/Layout/index.tsx', '2026-08-06'],
      ['website/src/theme/CodeBlock/Content/index.tsx', '2026-08-07'],
      ['website/scripts/jazz-highlighter.mjs', '2026-08-08'],
